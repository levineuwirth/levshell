...
WidgetWrapper {
    ...
    // Click toggles the process sniper ranked by CPU (spec §2.3.5) —
    // re-click collapses it, like every other bar icon's dropdown.
    interactive: true
    onClicked: shell.toggleProcessSniper("cpu")
